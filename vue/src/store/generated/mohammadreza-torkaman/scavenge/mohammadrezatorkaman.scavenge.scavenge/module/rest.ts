...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/mohammadreza-torkaman/scavenge/scavenge/commit
   */
  queryCommitAll = (
    query?: {
    ...
    this.request<ScavengeQueryAllCommitResponse, RpcStatus>({
      path: `/mohammadreza-torkaman/scavenge/scavenge/commit`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/mohammadreza-torkaman/scavenge/scavenge/commit/{index}
   */
  queryCommit = (index: string, params: RequestParams = {}) =>
    this.request<ScavengeQueryGetCommitResponse, RpcStatus>({
      path: `/mohammadreza-torkaman/scavenge/scavenge/commit/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/mohammadreza-torkaman/scavenge/scavenge/scavenge
   */
  queryScavengeAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<ScavengeQueryAllScavengeResponse, RpcStatus>({
      path: `/mohammadreza-torkaman/scavenge/scavenge/scavenge`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/mohammadreza-torkaman/scavenge/scavenge/scavenge/{index}
   */
  queryScavenge = (index: string, params: RequestParams = {}) =>
    this.request<ScavengeQueryGetScavengeResponse, RpcStatus>({
      path: `/mohammadreza-torkaman/scavenge/scavenge/scavenge/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/mohammadrezatorkaman/scavenge/scavenge/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ScavengeQueryParamsResponse, RpcStatus>({
      path: `/mohammadrezatorkaman/scavenge/scavenge/params`,
      method: "GET",
      format: "json",
      ...params,
    });
